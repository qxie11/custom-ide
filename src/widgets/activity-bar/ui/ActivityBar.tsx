...
import {Files, Settings2, GitFork, Search, Puzzle, UserCircle} from 'lucide-react';
import {Button} from '@/shared/ui/button';
import {Tooltip, TooltipContent, TooltipProvider, TooltipTrigger} from '@/shared/ui/tooltip';
import {BrandIcon} from '@/shared/assets/icons/BrandIcon';
            ...
            <Tooltip key={item.name}>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className={`h-10 w-10 rounded-none ${activePanel === item.name ? 'text-accent bg-accent/10 border-l-2 border-accent' : 'hover:bg-accent/5'}`}
